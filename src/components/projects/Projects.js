  ...
  return (
    <div className="Projects">
      ...
      <div className="projects-cards">
        <Cards
          title="Kemdi Attire"
          lang="// python(fastAPI), Typescript(Next.JS, Node.JS, Express.JS, Nest.JS)"
          img={rec1}
          desc="Kemdi Attire is an application that uses Artificial Intelligence to take measurements of users from an uploaded video."
          url="https://kemdiattire.com"
        />
        <Cards
          title="FashionAI"
